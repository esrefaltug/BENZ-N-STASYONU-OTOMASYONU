    ...
    public partial class Form1 : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (1000 < E_benzin95 + D_benzin95 || 0 >= E_benzin95  )
                    textBox1.Text = "HATA";
                else
            ...
            try
            {
                ...
                if (1000 < E_benzin97 + D_benzin97 || 0 >= E_benzin97 )
                    textBox2.Text = "HATA";
                else
            ...
            try
            {
                ...
                if (1000 < E_dizel + D_dizel || 0 >= E_dizel )
                    textBox3.Text = "HATA";
                else
            ...
            try
            {
                ...
                if (1000 < E_eurodizel + D_eurodizel || 0 >= E_eurodizel )
                    textBox4.Text = "HATA";
                else
        ...
        private void progress_bar_guncelle()
        {
